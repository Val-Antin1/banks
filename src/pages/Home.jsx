        ...
        <div className="relative max-w-7xl mx-auto px-6 py-32 text-center">
          ...
          <div className="mt-12 flex justify-center gap-6 flex-wrap">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-full font-bold text-lg hover:bg-blue-600 hover:text-white transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/30 hover:scale-105 inline-flex items-center gap-2"
            >
