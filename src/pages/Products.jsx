          ...
          <div className="mt-20 text-center">
            <div className="bg-gradient-to-r from-gray-100 to-white rounded-2xl p-12 border border-gray-300/50">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-8 py-4 rounded-full font-bold hover:shadow-lg hover:shadow-blue-500/50 hover:scale-105 transition-all duration-300"
              >
                ...
                <div className="lg:w-1/2 p-8">
                  ...
                  <div className="flex gap-4">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-full font-bold hover:shadow-lg hover:shadow-blue-500/50 hover:scale-105 transition-all duration-300 text-center"
                    >
                      Chat on WhatsApp
                    </a>
                  </div>
