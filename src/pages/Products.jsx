                ...
                <div className="lg:w-1/2 p-8">
                  ...
                  <div className="flex gap-4">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex-1 bg-green-500 hover:bg-green-600 text-white px-6 py-4 rounded-full font-bold hover:shadow-lg hover:shadow-green-500/50 hover:scale-105 transition-all duration-300 text-center text-lg"
                    >
